        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    ...
                    <?php if ($usuario["access"] == "A") : ?> <li><a href="<?php echo site_url('colaboradores'); ?>" class="nav-link px-2 link-secondary text-light">Colaboradores</a></li> <?php endif ?>
                    <?php if ($usuario["access"] == "A") : ?> <li><a href="<?php echo site_url('produtos'); ?>" class="nav-link px-2 link-secondary text-light">Produtos</a></li> <?php endif ?>
                ...
                <div class="dropdown text-end col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                    <span href="#" class="d-block link-light text-decoration-none"><?php echo $usuario["name"]; ?></span>
                </div>
                <div class="dropdown text-end col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
