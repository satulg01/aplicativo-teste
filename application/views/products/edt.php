...
<div class="container text-light">
    ...
    <form action="" id="form-edt">
        <div class="mb-3">
            ...
            <input type="text" class="form-control bg-secondary text-light" id="nome" name="name" value="<?php echo $product["name"]; ?>" />
        </div>

        <div class="mb-3">
            <label for="cpf" class="form-label">Descrição</label>
            <textarea class="form-control bg-secondary text-light" id="descricao" name="description"><?php echo $product["description"] ?></textarea>
        </div>

        <div class="mb-3">
            <label for="cpf" class="form-label">Marca</label>
            <input type="text" class="form-control bg-secondary text-light" id="marca" name="brand" value="<?php echo $product["brand"]; ?>">
        </div>
